...
const ProductContentList = () => {
  ...
  const productContentData = productContentListData?.data;
  ...
  const filteredProductData = productContentData?.filter((item) => {
    ...
    const matchesProductType =
      !productType || item.typeOfProduct === productType;
                  ...
                  <div className="container-fluid ">
                    <div className="d-flex justify-content-between align-items-center mb-4 flex-wrap">
                      <div className="card-header">
                        <h4 className="card-title">{productContentList}</h4>
                      </div>
                  ...
                  <div className="container-fluid">
                    <div className="d-flex justify-content-between align-items-center mb-4 flex-wrap">
                      <div className="col-sm-2 form-group mb-2">
                        <label htmlFor="name-f">{statusWise}</label>
                        <Dropdown
                          value={status}
                      ...
                      <div className="col-sm-2 form-group mb-2">
                        <label htmlFor="name-f">{typeOfProduct}</label>
                        <Dropdown
                          value={productType}
                      ...
                      <div className="col-sm-2 form-group mb-2">
                        <label htmlFor="name-f">{category_label}</label>
                        <Dropdown
                          value={category}
                      ...
                      <div className="col-xl-2">
                        <div className="example">
                          <label htmlFor="name-f">{date_label}</label>
                          <DatePicker
                            id="dateStartEnd"
                      ...
                      <div className="col-sm-2 form-group mb-2">
                        <label htmlFor="name-f">{sortedBy}</label>
                        <select
                          value={sortOption}
                    ...
                    {productContentListData.isLoading ? (
