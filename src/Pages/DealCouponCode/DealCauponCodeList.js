...
import DealCategoryForm from "./DealCauponCodeForm";
import DealCauponCodeForm from "./DealCauponCodeForm";

const DealCauponCodeList = () => {
    const dealCategoryData = [
        {
            categoryName: "TopOffers", mobileImage: "mobileImage", webImage: "webImage",
...
export default DealCauponCodeList;
