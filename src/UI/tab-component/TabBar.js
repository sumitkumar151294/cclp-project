...
import hotelIcon from '../../Assets/imgNewUI/tab-icon/hotel_icon1.png';
import cartIcon from '../../Assets/imgNewUI/tab-icon/cart_icon1.png';
import giftIcon from '../../Assets/imgNewUI/tab-icon/gift_icon1.png';
import offerIcon from '../../Assets/imgNewUI/tab-icon/offer_icon1.png';
import textIcon from '../../Assets/imgNewUI/tab-icon/text_icon1.png';
  ...
  return (
    <div className='tab_bar_wrapper'>
        <div className='tab_bar_menu d-flex align-item-center justify-content-between'>
            ...
            <div className='sub_menu_bar_wrapper'>
                <div className='menu_bar'>
                    <img src={offerIcon} alt='gift_icon'/>
                    {/* <p>Gift Card</p> */}
                </div>
                <span>Up to 25X Rewards</span>
            </div>
